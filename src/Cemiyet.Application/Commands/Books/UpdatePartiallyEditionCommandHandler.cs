...
{
    public class UpdatePartiallyEditionCommandHandler : IRequestHandler<UpdatePartiallyEditionCommand>
    {
        private readonly AppDataContext _context;

        public UpdatePartiallyEditionCommandHandler(AppDataContext context)
        {
            _context = context;
        }
