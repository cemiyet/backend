...
{
    public class DetailsEditionQueryHandler : IRequestHandler<DetailsEditionQuery, BookEditionViewModel>
    {
        private readonly AppDataContext _context;

        public DetailsEditionQueryHandler(AppDataContext context)
        {
            _context = context;
        }
